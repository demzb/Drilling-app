...
app.post('/generate-summary', async (req, res) => {
  ...
  if (!process.env.API_KEY) {
    ...
    return res.status(500).json({ error: "AI service is not configured correctly. API key is missing. Please set the API_KEY environment variable in your Vercel project settings." });
  }
...
// This is necessary for Vercel to treat this as a serverless function
export default app;