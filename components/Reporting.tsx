                ...
                <div className="bg-white p-6 rounded-lg shadow-xl mt-8">
                    <div className="flex flex-wrap justify-between items-center mb-4 gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={() => setReportData(null)} className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 transition-all shadow-sm">
