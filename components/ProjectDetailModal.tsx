...
import { exportProjectDetailToCSV } from '../utils/exportUtils';
...
const ProjectDetailModal: React.FC<ProjectDetailModalProps> = ({ isOpen, onClose, project, onUpdateProject, employees, onEditProject }) => {
  ...
  const handlePrint = () => {
    const printContent = document.getElementById('project-detail-content-for-print');
    if (printContent) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto">
            <div id="project-detail-content-for-print" className="p-6 space-y-6">
              {/* Project Info */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <form onSubmit={handleMaterialFormSubmit} className="mt-4 p-3 bg-gray-50 rounded-lg no-print">
                ...
                <div>
                  ...
                  <div className="border rounded-lg overflow-hidden max-h-64 overflow-y-auto">
                   ...
                   <form onSubmit={handleStaffFormSubmit} className="mt-4 p-3 bg-gray-50 rounded-lg no-print">
               ...
               <div className="pt-4">
                  ...
                  <form onSubmit={handleExpenseFormSubmit} className="mt-4 p-3 bg-gray-50 rounded-lg no-print">
        ...
        <div className="flex justify-between items-center p-4 bg-gray-50 border-t no-print">
            <div>
                <span className="text-sm font-medium text-gray-600 mr-2">Export Details:</span>
                <button
                    onClick={() => exportProjectDetailToCSV(project)}
            ...
            <div className="flex items-center space-x-2">
                <button
                    ...
                    className="px-4 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 shadow-sm"
                >
                    Edit Project Info
                </button>
